...
public class SocketServer : MonoBehaviour
{
    ...
    private void ListenForIncommingRequest()
    {
        try
        {
            ...
            tcpListener = new TcpListener(System.Net.IPAddress.Any, 50003);
            tcpListener.Start();
    ...
    {
        Debug.Log("HandleClientWorker()");
        using (TcpClient client = token as TcpClient)
        {
            Debug.Log("token as TcpClient");
        ...
        //listConnectClients.Add(connectedTcpClient);
        // Get a stream object for reading
    ...
    {
        //foreach(TcpClient client in listConnectClients)
        {
    ...
    private void DirectionHandler(int displayId, int payloadLength, byte[] bytes)
    {
